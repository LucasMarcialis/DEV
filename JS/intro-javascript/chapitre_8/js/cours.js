var Personnage = {
    ...
    attaquer: function(cible) {
        if (this.sante > 0) {
            ...
            console.log(this.nom + " ne peut pas attaquer : " + cible.nom + " est mort !");
        }
    },
};
...
Joueur.initJoueur = function(nom, sante, force) {
    ...
    this.xp = 0; // L'expérience est toujours initialisée à 0
}
// Renvoie la description du joueur
Joueur.decrire = function () {
    var description = this.nom + " a " + this.sante + " points de vie, " +
        this.force + " en force et " + this.xp + " points d'expérience, " + this.inventaire.or + " pièces d'or et " + this.inventaire.cles + " clé(s)";
    return description;
};
